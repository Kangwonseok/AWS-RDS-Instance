...
router.post('/insert', function (request, response) {
    ...
    connection.query('insert into candidate (name, address, part, introduce) values (?, ?, ?, ?);',
                  [ request.body.name, request.body.address, request.body.part, request.body.introduce ]);
...
router.post('/update/:id', function (request, response) {
    ...
    connection.query('update candidate set name=?, address=?, part=?, introduce=? where id=?;',
                     [ request.body.name, request.body.address, request.body.part, request.body.introduce, request.params.id ]);
